// left image
var randomNumber1 = Math.round((Math.random() * 6)); // generate a random num

var randomLeftImageSrc = "images/dice" + randomNumber1 + ".png"; // change image num

document.querySelectorAll("img")[0].setAttribute("src", randomLeftImageSrc); // change attribute src

// right image
var randomNumber2 = Math.round((Math.random() * 6)); // generate a random num
